        ...
        <div className="container">
            <div className="row">
                <div className="d-flex justify-content-end my-3">
                    <Link to={`/appointments/sitters/new`} className="btn btn-primary">New sitter's appointment</Link>
                </div>
                {
                    appointmentSitter?.appointments?.map(el =>
                            ...
                            <div className="card flex-row d-flex justify-content-evenly">
                                ...
                                <div className="card-footer col-lg-3 border-top-0 bg-transparent">
                                    <div className="d-flex justify-content-end flex-wrap gap-4">
                                        <i onClick={() => navigate("/appointments/sitters/"+ el.id)} className="fa-solid fa-info fs-3"></i>
                                        <i onClick={() => {deleteAppointmentSitter(el.id) }} className="fa-regular fa-trash-can fs-3"></i>
                                        <i onClick={() => navigate("/appointments/sitters/edit/" + el.id)} className="fa-regular fa-pen-to-square fs-3"></i>
                                    </div>
                                </div>
                            </div>
                        </div>)
